...
def send_email(msg):
    try:
        ...
        mail.ehlo()
        mail.starttls()
        mail.login('affanshaikhsurabofficial@gmail.com', 'affanshaikhsurabofficial@youtube')  # Replace with actual email and password
...
def check_inbox():
    try:
        ...
        mail.login('affanshaikhsurabofficial@gmail.com', 'your_password')  # Replace with actual email and password
        mail.select('Inbox')
